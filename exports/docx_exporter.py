...
def export_to_docx(
    ...
    *,
    ...
    _add_concise_topics(document, payload)
    ...
    _add_next_steps(document, payload)
...
def _add_mom_title_block(
    ...
    *,
    ...
    title = payload.get("summary", {}).get("title") or "Meeting"

    heading = document.add_paragraph()
    heading.alignment = WD_ALIGN_PARAGRAPH.CENTER
    heading.paragraph_format.space_after = Pt(10)
    run = heading.add_run("MINUTES OF MEETING")
    run.bold = True
